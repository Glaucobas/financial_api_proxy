...
class TransactionsSchema(BaseModel):
    ...
    transaction_date: date = Field(None, example=date.today())
    transaction_expiration_date: date = Field(None, example=date.today())
    transaction_description: str = Field(None, max_length=200, example=EXEMPLE_DESCRIPTION)
    category_id: str = Field(None, min_length=1, max_length=3, example=EXEMPLE_CATEGORY)
    account_id:  int = Field(None, example=EXEMPLE_ACCOUNT)
    branch_id:  int = Field(None, example=EXEMPLE_BRANCH)
    resource_id: str = Field(None, min_length=1, max_length=3, example=EXEMPLE_RESOURCE)
    transaction_type: str = Field(..., min_length=1, max_length=3, example=EXEMPLE_TYPE)
    transaction_value: float = Field(..., example=EXEMPLE_VALUE)
    transaction_status: str = Field(..., min_length=1, max_length=3, example=EXEMPLE_STATUS)
...
class TransactionsUpdateSchema(BaseModel):
    ...
    transaction_id:  int = Field(..., example=EXEMPLE_ID)
    transaction_date: Optional[date ]= Field(None, example=date.today())
    transaction_expiration_date: Optional[date] = Field(None, example=date.today())
    transaction_description: Optional[str] = Field(None, max_length=200, example=EXEMPLE_DESCRIPTION)
    category_id: Optional[str] = Field(None, min_length=1, max_length=3, example=EXEMPLE_CATEGORY)
    account_id:  Optional[int] = Field(None, example=EXEMPLE_ACCOUNT)
    branch_id:  Optional[int] = Field(None, example=EXEMPLE_BRANCH)
    resource_id: Optional[str] = Field(None, min_length=1, max_length=3, example=EXEMPLE_RESOURCE)
    transaction_type: Optional[str] = Field(None, min_length=1, max_length=3, example=EXEMPLE_TYPE)
    transaction_value: Optional[float] = Field(None, example=EXEMPLE_VALUE)
    transaction_status: Optional[str] = Field(None, min_length=1, max_length=3, example=EXEMPLE_STATUS)
